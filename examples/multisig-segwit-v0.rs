...
//!
//! An example of using PSBT v2 to create a 2 of 2 multisig by spending two native segwit v0 inputs
...
fn main() -> anyhow::Result<()> {
    ...
    // In PSBT v2 the creator and constructor roles can be the same entity, for an example of having
    // them act separately see `./separate-creator-constructor.rs`.
    ...
    let updated = psbt_v2::combine(updated_by_a, updated_by_b)?;
    ...
    let _signed = psbt_v2::combine(signed_by_a, signed_by_b);
